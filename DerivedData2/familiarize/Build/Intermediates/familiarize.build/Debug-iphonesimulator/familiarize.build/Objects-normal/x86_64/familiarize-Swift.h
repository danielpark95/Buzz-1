...
SWIFT_CLASS("_TtC11familiarize11AppDelegate")
...
SWIFT_CLASS("_TtC11familiarize8BaseCell")
...
SWIFT_CLASS("_TtC11familiarize7MenuBar")
...
SWIFT_CLASS("_TtC11familiarize8MenuCell")
...
- (void)viewDidLoad;
@property (nonatomic, readonly, strong) UILabel * _Nonnull questionLabel;
...
- (void)didSelectAddWithSender:(UIButton * _Nonnull)sender;
...
- (void)passNameToPopup:(PopupController * _Nonnull)popupController;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end
