...
//  familiarize
//
//  Created by Daniel Park on 7/30/17.
...
NSDictionary *headers = @{@"X-Mashape-Key": @"KT41kN7vl7mshiGSRoAZ3gU2UZpIp1dT1vgjsnqHC0CQqRL0ys", @"Content-Type": @"application/json", @"Accept": @"application/json"};
NSURLConnection *asyncConnection = [[UNIRest post:^(UNISimpleRequest *request) {
