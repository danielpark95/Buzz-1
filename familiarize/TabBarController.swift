...
class TabBarController: ESTabBarController, UITabBarControllerDelegate {
    override func viewDidLoad() {
        ...
        userController.tabBarItem = ESTabBarItem.init(ExampleIrregularityBasicContentView(), title: "", image: UIImage(named: "dan_me_grey"), selectedImage: UIImage(named: "dan_me_lightgreen"))
        ...
        scannerController.tabBarItem = ESTabBarItem.init(ExampleIrregularityContentView(),title: nil, image: UIImage(named: "dan_tabbarcircle_grey"), selectedImage: UIImage(named: "dan_tabbarcircle_grey"))
        ...
        contactsController.tabBarItem = ESTabBarItem.init(ExampleIrregularityBasicContentView(), title: "", image: UIImage(named: "dan_friends_grey"), selectedImage: UIImage(named: "dan_friends_lightgreen"))
