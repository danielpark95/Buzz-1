...
class TabBarController: ESTabBarController, UITabBarControllerDelegate {
    override func viewDidLoad() {
        ...
        userController.tabBarItem = ESTabBarItem.init(ExampleIrregularityBasicContentView(), title: "", image: UIImage(named: "dan_me_grey_2"), selectedImage: UIImage(named: "dan_me_black"))
        ...
        contactsController.tabBarItem = ESTabBarItem.init(ExampleIrregularityBasicContentView(), title: "", image: UIImage(named: "dan_friends_grey_2"), selectedImage: UIImage(named: "dan_friends_black"))
